    ...
    return (         
        <section className="slider">
            <div className="home-slider owl-carousel owl-theme">
                <div className="items">
                    <div className="img-back" style={{backgroundImage:"url(/assets/image/slider1.jpg)"}}>
                ...
                <div className="items">
                    <div className="img-back" style={{backgroundImage:"url(/assets/image/slider2.jpg)"}}>
                ...
                <div className="items">
                    <div className="img-back" style={{backgroundImage:"url(/assets/image/slider3.jpg)"}}>
