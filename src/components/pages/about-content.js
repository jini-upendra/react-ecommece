                    ...
                    <div className="row">
                        <div className="col">
                            <div className="about-title">
                                ...
                                <img src="assets/image/about-image-pro.jpg" className="p-image" alt="pro-image" />
                            </div>
                        ...
                        <div className="row">
                            <div className="col">
                                <div className="text-center">
                                    ...
                                    <div className="counter">
                                        <h2 className="timer count-title count-number" data-to="210" data-speed="1500"></h2>
                                        <p className="count-text ">Clients And Partners</p>
                                    </div>
                                    <div className="counter">
                                        <h2 className="timer count-title count-number" data-to="18" data-speed="1500"></h2>
                                        <p className="count-text ">Show Room</p>
                                    </div>
                                    <div className="counter">
                                        <h2 className="timer count-title count-number" data-to="17" data-speed="1500"></h2>
