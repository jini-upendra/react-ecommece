                        ...
                        <div className="home-offer-banner">
                            <div className="o-t-banner">
                                <a href="product.html" className="image-b">
                                    <img className="img-fluid" src="assets/image/banner-1.jpg" alt="banner image" />
                                </a>
                                <div className="o-t-content">
                                    <h6>Fresh fruits, vagetable on our product</h6>
                                    <a href="product.html" className="btn btn-style1">Shop now</a>
                                </div>
                            </div>
                            <div className="o-t-banner">
                                <a href="product.html" className="image-b">
                                    <img className="img-fluid" src="assets/image/banner-2.jpg" alt="banner image" />
                                </a>
