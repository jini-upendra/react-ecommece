...
const MobileMenu = () => {
    return (         
        <div className="header-bottom-area mobile">
                        ...
                        <div className="main-menu-area">
                            <div className="main-navigation navbar-expand-xl">
                                <div className="box-header menu-close">
                                    <button className="close-box" type="button"><i className="ion-close-round"></i></button>
                                </div>
                                <div className="navbar-collapse" id="navbarContent01">
                                        ...
                                        <div className="mainwrap">
                                            <ul className="main-menu">
                                                <li className="menu-link parent">
                                                    ...
                                                    <a href="#collapse-home1" data-bs-toggle="collapse" className="link-title link-title-lg">
                                                        <span className="sp-link-title">Home</span>
                                                        <i className="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul className="dropdown-submenu sub-menu collapse" id="collapse-home1">
                                                        ...
                                                        <li className="submenu-li">
                                                            <a href="index8.html" className="submenu-link">Vegist home 08</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li className="menu-link parent">
                                                    ...
                                                    <a href="#collapse-mega-menu1" data-bs-toggle="collapse" className="link-title link-title-lg">
                                                        <span className="sp-link-title">Shop</span>
                                                        <i className="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul className="dropdown-submenu mega-menu collapse" id="collapse-mega-menu1">
                                                        <li className="megamenu-li parent">
                                                            <h2 className="sublink-title">Fresh food</h2>
                                                            <a href="#collapse-sub-mega-menu1" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Fresh food</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="collapse-sub-mega-menu1">
                                                        ...
                                                        <li className="megamenu-li parent">
                                                            ...
                                                            <a href="#collapse-fruits-menu1" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Mixedfruits</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="collapse-fruits-menu1">
                                                        ...
                                                        <li className="megamenu-li parent">
                                                            ...
                                                            <a href="#collapse-banana-menu1" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Bananas & plantains</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="collapse-banana-menu1">
                                                        ...
                                                        <li className="megamenu-li parent">
                                                            ...
                                                            <a href="#collapse-apple-menu1" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Apples berries</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="collapse-apple-menu1">
                                                ...
                                                <li className="menu-link parent">
                                                    ...
                                                    <a href="#collapse-banner-menu1" data-bs-toggle="collapse" className="link-title link-title-lg">
                                                        <span className="sp-link-title">Collection</span>
                                                        <i className="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul className="dropdown-submenu banner-menu collapse" id="collapse-banner-menu1">
                                                        <li className="menu-banner">
                                                            <a href="grid-list.html" className="menu-banner-img"><img src="../assets/image/menu-banner01.jpg" alt="menu-image" className="img-fluid" /></a>
                                                            <a href="grid-list.html" className="menu-banner-title"><span>Bestseller</span></a>
                                                        </li>
                                                        <li className="menu-banner">
                                                            <a href="grid-list.html" className="menu-banner-img"><img src="../assets/image/menu-banner02.jpg" alt="menu-image" className="img-fluid" /></a>
                                                            <a href="grid-list.html" className="menu-banner-title"><span>Special product</span></a>
                                                        </li>
                                                        <li className="menu-banner">
                                                            <a href="grid-list.html" className="menu-banner-img"><img src="../assets/image/menu-banner03.jpg" alt="mneu image" className="img-fluid" /></a>
                                                ...
                                                <li className="menu-link parent">
                                                    ...
                                                    <a href="#collapse-page-menu1" data-bs-toggle="collapse" className="link-title link-title-lg">
                                                        <span className="sp-link-title">Pages</span>
                                                        <i className="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul className="dropdown-submenu sub-menu collapse" id="collapse-page-menu1">
                                                        <li className="submenu-li">
                                                            <a href="about-us.html" className="submenu-link">About us</a>
                                                        </li>
                                                        <li className="submenu-li">
                                                            <a href="" className="g-l-link"><span>Account</span> <i className="fa fa-angle-right"></i></a>
                                                            <a href="#account-menu1" data-bs-toggle="collapse" className="sub-link"><span>Account</span> <i className="fa fa-angle-down"></i></a>
                                                            <ul className="collapse blog-style-1" id="account-menu1">
                                                                <li>
                                                ...
                                                <li className="menu-link parent">
                                                    ...
                                                    <a href="#blog-style1" data-bs-toggle="collapse" className="link-title link-title-lg">
                                                        <span className="sp-link-title">Blogs</span>
                                                        <i className="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul className="dropdown-submenu sub-menu collapse" id="blog-style1">
                                                        <li className="submenu-li">
                                                            <a href="" className="g-l-link"><span>Blog grid</span> <i className="fa fa-angle-right"></i></a>
                                                            <a href="#blog-style031" data-bs-toggle="collapse" className="sub-link"><span>Blog grid</span> <i className="fa fa-angle-down"></i></a>
                                                            <ul className="collapse blog-style-1" id="blog-style031">
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#grid-1" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="grid-1">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#grid-2" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="grid-2">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#grid-3" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="grid-3">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#grid-4" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="grid-4">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#grid-5" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="grid-5">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#grid-6" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="grid-6">
                                                        ...
                                                        <li className="submenu-li">
                                                            <a href="" className="g-l-link"><span>Blog list</span> <i className="fa fa-angle-right"></i></a>
                                                            <a href="#blog-style-01" data-bs-toggle="collapse" className="sub-link"><span>Blog list</span> <i className="fa fa-angle-down"></i></a>
                                                            <ul className="collapse blog-style-1" id="blog-style-01">
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-1a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-1a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-22a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-22a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-33a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-33a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-44a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-44a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-55a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-55a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-66a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-66a">
                                                                        <li><a href="blog-style-7-list-blog.html">Blog list</a></li>
                                                                        <li><a href="blog-style-7-left-list-blog.html">Left blog list</a></li>
                                                                        <li><a href="blog-style-7-right-list-blog.html">Right blog list</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li className="submenu-li">
                                                            <a href="" className="g-l-link"><span>Blog details</span> <i className="fa fa-angle-right"></i></a>
                                                            <a href="#blog-style-02" data-bs-toggle="collapse" className="sub-link"><span>Blog Details</span> <i className="fa fa-angle-down"></i></a>
                                                            <ul className="collapse blog-style-1 ex-width" id="blog-style-02">
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog details style 1</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list-11a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 1</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list-11a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog details style 2</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list2a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 2</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list2a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog details style 3</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list3a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 3</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list3a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog details style 4</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list4a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 4</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list4a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog details style 5</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list5a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 5</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list5a">
                                                                ...
                                                                <li>
                                                                    <a href="" className="sub-style"><span>Blog details style 6</span><i className="fa fa-angle-right"></i></a>
                                                                    <a href="#list6a" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 6</span><i className="fa fa-angle-right"></i></a>
                                                                    <ul className="grid-style collapse" id="list6a">
                                                        ...
                                                        <li className="submenu-li">
                                                            <a href="" className="g-l-link"><span>Center blog</span> <i className="fa fa-angle-right"></i></a>
                                                            <a href="#center-blog-1" data-bs-toggle="collapse" className="sub-link"><span>Center blog</span> <i className="fa fa-angle-down"></i></a>
                                                            <ul className="collapse blog-style-1" id="center-blog-1">
                                                                <li>
                                                ...
                                                <li className="menu-link parent">
                                                    ...
                                                    <a href="#feature-1" data-bs-toggle="collapse" className="link-title link-title-lg">
                                                        <span className="sp-link-title">Feature</span>
                                                        <i className="fa fa-angle-down"></i>
                                                    </a>
                                                    <ul className="dropdown-submenu mega-menu collapse" id="feature-1">
                                                        <li className="megamenu-li parent">
                                                            <h2 className="sublink-title">Header style</h2>
                                                            <a href="#feature-01" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Header style</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="feature-01">
                                                        ...
                                                        <li className="megamenu-li parent">
                                                            ...
                                                            <a href="#feature-02" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Footer style</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="feature-02">
                                                        ...
                                                        <li className="megamenu-li parent">
                                                            ...
                                                            <a href="#feature-03" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Product details</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="feature-03">
                                                        ...
                                                        <li className="megamenu-li parent">
                                                            ...
                                                            <a href="#feature-04" data-bs-toggle="collapse" className="sublink-title sublink-title-lg">
                                                                <span>Other style</span>
                                                                <i className="fa fa-angle-down"></i>
                                                            </a>
                                                            <ul className="dropdown-supmenu collapse" id="feature-04">
                                ...
                                <div className="img-hotline">
                                    <div className="image-line">
                                        <a href=""><img src="../assets/image/icon_contact.png" className="img-fluid" alt="image-icon" /></a>
                                    </div>
