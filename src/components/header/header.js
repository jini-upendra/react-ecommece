    ...
    return (
        <header className="header-area">
                        ...
                        <div className="col">
                            <div className="header-main">
                                <div className="header-element logo">
                                    <Link to="/">
                                        <img src="../assets/image/logo1.png" alt="logo-image" className="img-fluid" />
                                    </Link>
                                </div>
                                <div className="header-element search-wrap">
                                    <input type="text" name="search" placeholder="Search product." />
                                    <a href="search.html" className="search-btn"><i className="fa fa-search"></i></a>
                                </div>
                                                ...
                                                <div className="shopping-cart">
                                                    <a href="" className="cart-count">
                                                        <span className="cart-icon-wrap">
                                                            <span className="cart-icon"><i className="icon-handbag"></i></span>
                                                    ...
                                                    <ul className="main-menu">
                                                        ...
                                                        <li className="menu-link parent">
                                                            ...
                                                            <ul className="dropdown-submenu sub-menu collapse" id="collapse-page-menu">
                                                                <li className="submenu-li">
                                                                    <Link to="about">
                                                                    <a  className="submenu-link">About us</a>
                                                                    </Link>
                                                                </li>
                                                                <li className="submenu-li">
                                                                    <a href="" className="g-l-link"><span>Account</span> <i className="fa fa-angle-right"></i></a>
                                                                    <a href="#account-menu" data-bs-toggle="collapse" className="sub-link"><span>Account</span> <i className="fa fa-angle-down"></i></a>
                                                        ...
                                                        <li className="menu-link parent">
                                                            ...
                                                            <ul className="dropdown-submenu sub-menu collapse" id="blog-style">
                                                                <li className="submenu-li">
                                                                    ...
                                                                    <a href="#blog-style03" data-bs-toggle="collapse" className="sub-link"><span>Blog grid</span> <i className="fa fa-angle-down"></i></a>
                                                                    <ul className="collapse blog-style-1" id="blog-style03">
                                                                        <li>
                                                                            ...
                                                                            <a href="#grid1" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#grid2" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#grid3" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#grid4" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#grid5" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#grid6" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                ...
                                                                <li className="submenu-li">
                                                                    ...
                                                                    <a href="#blog-style01" data-bs-toggle="collapse" className="sub-link"><span>Blog list</span> <i className="fa fa-angle-down"></i></a>
                                                                    <ul className="collapse blog-style-1" id="blog-style01">
                                                                        <li>
                                                                            <a href="" className="sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                            <a href="#list-1" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 1</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            <a href="" className="sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                            <a href="#list-22" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 2</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            <a href="" className="sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                            <a href="#list-33" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 3</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            <a href="" className="sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                            <a href="#list-44" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 4</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            <a href="" className="sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                            <a href="#list-55" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 5</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            <a href="" className="sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                            <a href="#list-66" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog style 6</span><i className="fa fa-angle-right"></i></a>
                                                                ...
                                                                <li className="submenu-li">
                                                                    ...
                                                                    <a href="#blog-style02" data-bs-toggle="collapse" className="sub-link"><span>Blog Details</span> <i className="fa fa-angle-down"></i></a>
                                                                    <ul className="collapse blog-style-1 ex-width" id="blog-style02">
                                                                        <li>
                                                                            ...
                                                                            <a href="#list-11" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 1</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#list2" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 2</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#list3" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 3</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#list4" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 4</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#list5" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 5</span><i className="fa fa-angle-right"></i></a>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <a href="#list6" data-bs-toggle="collapse" className="blog-sub-style"><span>Blog details style 6</span><i className="fa fa-angle-right"></i></a>
                                                                ...
                                                                <li className="submenu-li">
                                                                    ...
                                                                    <a href="#center-blog" data-bs-toggle="collapse" className="sub-link"><span>Center blog</span> <i className="fa fa-angle-down"></i></a>
            ...
            <div className="mini-cart">
                <a href="" className="shopping-cart-close"><i className="ion-close-round"></i></a>
                ...
                <ul className="cart-item-loop">
                    <li className="cart-item">
                        <div className="cart-img">
                            <a href="product.html">
                                <img src="../assets/image/cart-img.jpg" alt="cart-image" className="img-fluid" />
                            </a>
                        </div>
                    ...
                    <li className="cart-item">
                        <div className="cart-img">
                            <a href="product.html">
                                <img src="../assets/image/cart-img02.jpg" alt="cart-image" className="img-fluid" />
                            </a>
                        </div>
                        <div className="cart-title">
                    ...
                    <li className="cart-item">
                        <div className="cart-img">
                            <a href="product.html">
                                <img src="../assets/image/cart-img03.jpg" alt="cart-image" className="img-fluid" />
                            </a>
                        </div>
                        <div className="cart-title">
                    ...
                    <li className="cart-item">
                        <div className="cart-img">
                            <a href="product.html">
                                <img src="../assets/image/cart-img04.jpg" alt="cart-image" className="img-fluid" />
                            </a>
                        </div>
                        <div className="cart-title">
